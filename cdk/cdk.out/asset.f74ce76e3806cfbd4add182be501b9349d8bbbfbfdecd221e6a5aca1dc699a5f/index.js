...
async function handlePost(userId, rawBody) {
  ...
  let feedUrlsFromBody;
  if (feedUrlsRaw !== void 0) {
    if (!Array.isArray(feedUrlsRaw) || feedUrlsRaw.length > 50 || !feedUrlsRaw.every((u) => typeof u === "string")) {
      return json(400, {
  ...
  const mergedFeedUrls = feedUrlsFromBody !== void 0 ? feedUrlsFromBody.length > 0 ? feedUrlsFromBody : null : prev.feedUrls;
    ...
    await dynamo.send(
      new import_client_dynamodb.PutItemCommand({
        ...
        Item: {
          ...
          ...mergedFeedUrls && mergedFeedUrls.length > 0 ? { feedUrls: { SS: mergedFeedUrls } } : {},
