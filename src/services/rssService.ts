...
export const RSS_FEEDS: RssFeed[] = [
  ...
  { id: 'shape', name: "Women's Health", url: 'https://www.womenshealthmag.com/rss/all.xml', category: 'fitness' },
  { id: 'self_mag', name: 'SELF', url: 'https://www.self.com/feed/rss', category: 'fitness' },
  ...
  { id: 'lonely_planet', name: 'NY Times Travel', url: 'https://rss.nytimes.com/services/xml/rss/nyt/Travel.xml', category: 'travel' },
